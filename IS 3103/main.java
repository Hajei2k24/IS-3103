...
public class Main {
    public static void main(String[] args) {
        ...
        items.add(new GroceryItem("Bakery", "Bread", 35.0, 40));
        items.add(new GroceryItem("Meat", "Chicken Breast", 90.0, 30));
        items.add(new GroceryItem("Fruit", "Banana", 22.0, 120));
        items.add(new GroceryItem("Drink", "Orange Juice", 75.0, 25));
        items.add(new GroceryItem("Vegetable", "Tomato", 28.0, 90));
        ...
        if (total == 0) {
            System.out.println("You didn't buy anything. Thanks for visiting!");
            scanner.close();
            return;
        }
        ...
        while (true) {
            ...
            if (payment < total) {
                System.out.println("Not enough money. Please pay at least $" + String.format("%.2f", total));
            } else {
                break;
            }
        }
